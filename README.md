...
3. [Fiber aligned strain & strain rate](https://bcunnane.github.io/FAS/)
4. [DICOM processing for Siemens CS 4D Flow sequence](https://bcunnane.github.io/CS_4D_flow/)
...
My research is advised by **Professor Usha Sinha** and studies the effects of sarcopenia, or muscle loss with age.  My projects (1) used **diffusion tensor imaging (DTI)** data to determine representative muscle fibers and (2) used **velocity encoded phase contrast (VEPC)** for **dynamic imaging** of these fibers’ motion compared to the force read by a foot pedal fixture. I also am (3) developing a method to align strain and strain rate in the direction of muscle fibers determined from DTI. This work is a collaboration between San Diego State and UC San Diego (UCSD), with data collected in a 1.5T GE scanner at UCSD’s Radiology Imaging Laboratory. In addition, I wrote a script to (4) process the VEPC data collected using the CS 4D Flow sequence on SDSU's 3T Siemens scanner.
