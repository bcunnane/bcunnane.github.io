...
advised by Professor Usha Sinha  
...
My research studies the effects of **sarcopenia**, or muscle loss with age. The loss of muscle strength with age is not proportional with loss of mass, indicating that there are other changes in the extracellular matrix responsible for this additional force loss. This investigation compares the muscle fiber strain in the medial gastrocnemius (MG) muscle of young and old subjects. This project is a collaboration between San Diego State and UC San Diego (UCSD), and data was collected at UCSD’s Radiology Imaging Laboratory in a 1.5T GE scanner with the subject's dominant leg fixed in a foot pedal fixture. This investigation (1) used **diffusion tensor imaging (DTI)** data to determine representative muscle fibers and (2) used **velocity encoded phase contrast imaging (VEPC)** for **dynamic imaging** of these fibers’ motion compared to the force read by the foot pedal.
